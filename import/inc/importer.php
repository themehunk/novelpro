...
class Themehunk_Library_WXR_Importer {
	...
	private function __construct() {
		...
		if ( ! class_exists( 'WP_Importer_Logger' ) ) {
			require_once THEMEHUNK_SITE_LIBRARY_DIR . 'wxr-importer/class-logger.php';
		}

		if ( ! class_exists( 'WP_Importer_Logger_ServerSentEvents' ) ) {
			require_once THEMEHUNK_SITE_LIBRARY_DIR . 'wxr-importer/class-wp-importer-logger-serversentevents.php';
		}

		if ( ! class_exists( 'WXR_Importer' ) ) {
			require_once THEMEHUNK_SITE_LIBRARY_DIR . 'wxr-importer/class-wxr-importer.php';
		}

		if ( ! class_exists( 'WXR_Import_Info' ) ) {
			require_once THEMEHUNK_SITE_LIBRARY_DIR . 'wxr-importer/class-wxr-import-info.php';
		}

		add_filter( 'upload_mimes', array( $this, 'custom_upload_mimes' ) );
		add_action( 'wp_ajax_themehunk-wxr-import', array( $this, 'sse_import' ) );
	...
	public function get_importer() {
		$options  = apply_filters(
			'themehunk_site_library_xml_import_options', array(
