<?php
if ( ! class_exists( 'Themehunk_Library_Notices' ) ) :

	/**
	 * Themehunk_Library_Notice
	 *
	 * @since 1.0.0
	 */
	class Themehunk_Library_Notices {
		...
		public function __construct() {
			...
			add_action( 'wp_ajax_themehunk-library-notices', array( $this, 'dismiss' ) );
		...
		function enqueue_scripts() {
			wp_register_script( 'themehunk-library-notices', THEMEHUNK_SITE_LIBRARY_URI . 'assets/js/notices.js', array( 'jquery' ), THEMEHUNK_SITE_LIBRARY_VER, true );
		}
		...
		function show_notices() {
			...
			foreach ( self::$notices as $key => $notice ) {
				...
				$classes = array( 'themehunk-notice', 'notice' );
				...
				// Notice ID.
				$notice_id = 'themehunk-library-notices-id-' . $key;
		...
		public static function markup( $notice = array() ) {
			...
			wp_enqueue_script( 'themehunk-library-notices' );
	 ...
	 */
	Themehunk_Library_Notices::get_instance();
