		...
		function () {
			...
			th.find( '.customizer-repeater-general-control-repeater-container' ).each(
				function () {
					...
					var bgclr     = jQuery( this ).find( 'input.customizer-repeater-bgclr-control' ).val();
					var titleclr     = jQuery( this ).find( 'input.customizer-repeater-titleclr-control' ).val();
					var textclr     = jQuery( this ).find( 'input.customizer-repeater-textclr-control' ).val();
					var buttonbg     = jQuery( this ).find( 'input.customizer-repeater-buttonbg-control' ).val();
					var buttonhvrbg     = jQuery( this ).find( 'input.customizer-repeater-buttonhvrbg-control' ).val();
					var buttonclr     = jQuery( this ).find( 'input.customizer-repeater-buttonclr-control' ).val();
					var buttonhvrclr     = jQuery( this ).find( 'input.customizer-repeater-buttonhvrclr-control' ).val();
					var borderclr     = jQuery( this ).find( 'input.customizer-repeater-borderclr-control' ).val();
					var priceclr     = jQuery( this ).find( 'input.customizer-repeater-priceclr-control' ).val();
						...
						values.push(
							{
								...
								'textclr': textclr,
								'buttonbg': buttonbg,
								'buttonhvrbg': buttonhvrbg,
								'buttonclr': buttonclr,
								'buttonhvrclr': buttonhvrclr,
								'borderclr': borderclr,
								'priceclr': priceclr,
...
jQuery( document ).ready(
	 ...
	 */
			...
			'click', '.customizer-repeater-new-field', function () {
				...
				if (typeof th !== 'undefined') {
					...
					if (typeof field !== 'undefined') {
						...
						field.find( 'div.customizer-repeater-bgclr-control .wp-picker-container' ).replaceWith( '<input type="text" class="customizer-repeater-bgclr-control ' + id + '">' );
						field.find( 'input.customizer-repeater-bgclr-control' ).wpColorPicker( color_options );

						field.find( 'div.customizer-repeater-titleclr-control .wp-picker-container' ).replaceWith( '<input type="text" class="customizer-repeater-titleclr-control ' + id + '">' );
						field.find( 'input.customizer-repeater-titleclr-control' ).wpColorPicker( color_options );

						field.find( 'div.customizer-repeater-textclr-control .wp-picker-container' ).replaceWith( '<input type="text" class="customizer-repeater-textclr-control ' + id + '">' );
						field.find( 'input.customizer-repeater-textclr-control' ).wpColorPicker( color_options );

						field.find( 'div.customizer-repeater-buttonbg-control .wp-picker-container' ).replaceWith( '<input type="text" class="customizer-repeater-buttonbg-control ' + id + '">' );
						field.find( 'input.customizer-repeater-buttonbg-control' ).wpColorPicker( color_options );

						field.find( 'div.customizer-repeater-buttonhvrbg-control .wp-picker-container' ).replaceWith( '<input type="text" class="customizer-repeater-buttonhvrbg-control ' + id + '">' );
						field.find( 'input.customizer-repeater-buttonhvrbg-control' ).wpColorPicker( color_options );

						field.find( 'div.customizer-repeater-buttonclr-control .wp-picker-container' ).replaceWith( '<input type="text" class="customizer-repeater-buttonclr-control ' + id + '">' );
						field.find( 'input.customizer-repeater-buttonclr-control' ).wpColorPicker( color_options );

						field.find( 'div.customizer-repeater-buttonhvrclr-control .wp-picker-container' ).replaceWith( '<input type="text" class="customizer-repeater-buttonhvrclr-control ' + id + '">' );
						field.find( 'input.customizer-repeater-buttonhvrclr-control' ).wpColorPicker( color_options );

						field.find( 'div.customizer-repeater-borderclr-control .wp-picker-container' ).replaceWith( '<input type="text" class="customizer-repeater-borderclr-control ' + id + '">' );
						field.find( 'input.customizer-repeater-borderclr-control' ).wpColorPicker( color_options );

						field.find( 'div.customizer-repeater-priceclr-control .wp-picker-container' ).replaceWith( '<input type="text" class="customizer-repeater-priceclr-control ' + id + '">' );
						field.find( 'input.customizer-repeater-priceclr-control' ).wpColorPicker( color_options );
		...
		jQuery( 'input.customizer-repeater-bgclr-control' ).wpColorPicker( color_options );
		jQuery( 'input.customizer-repeater-titleclr-control' ).wpColorPicker( color_options );
		jQuery( 'input.customizer-repeater-textclr-control' ).wpColorPicker( color_options );
		jQuery( 'input.customizer-repeater-buttonbg-control' ).wpColorPicker( color_options );
		jQuery( 'input.customizer-repeater-buttonhvrbg-control' ).wpColorPicker( color_options );
		jQuery( 'input.customizer-repeater-buttonclr-control' ).wpColorPicker( color_options );
		jQuery( 'input.customizer-repeater-buttonhvrclr-control' ).wpColorPicker( color_options );
		jQuery( 'input.customizer-repeater-borderclr-control' ).wpColorPicker( color_options );
		jQuery( 'input.customizer-repeater-priceclr-control' ).wpColorPicker( color_options );
