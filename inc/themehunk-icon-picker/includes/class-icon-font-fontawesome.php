<?php
/**
 * FontAwesome Icons for Themehunk Icon Picker
 * @link http://fontawesome.io/
 */
class Themehunk_Icon_Picker_FontAwesome extends Themehunk_Icon_Picker_Font {
	function get_id() {
		return 'fontawesome';
	}

	function get_label() {
		return __( 'FontAwesome', 'novelpro' );
	}

	/**
	 * Check if the icon name belongs to the Themehunk icon font
	...
	function get_icons() {
		return array(
			...
			array(
				'key' => 'accessibility',
				'label' => __( 'Accessibility', 'novelpro' ),
				'icons' => array(
					'fa-american-sign-language-interpreting' => 'american-sign-language-interpreting',
					'fa-assistive-listening-systems' => 'assistive-listening-systems',
					'fa-audio-description' => 'audio-description',
			...
			array(
				'key' => 'transportation',
				'label' => __( 'Transportation', 'novelpro' ),
				'icons' => array(
			...
			array(
				'key' => 'form-control',
				'label' => __( 'Form Control', 'novelpro' ),
				'icons' => array(
					'fa-check-square' => 'check-square',
					'fa-check-square-o' => 'check-square-o',
					'fa-circle' => 'circle',
			...
			array(
				'key' => 'video-player',
				'label' => __( 'Video Player', 'novelpro' ),
				'icons' => array(
					'fa-arrows-alt' => 'arrows-alt',
