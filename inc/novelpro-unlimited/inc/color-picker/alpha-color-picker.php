...
class Customize_Alpha_Color_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script(
			'alpha-color-picker',
			get_template_directory_uri() . '/inc/novelpro-unlimited/inc/color-picker/alpha-color-picker.js',
		...
		wp_enqueue_style(
			'alpha-color-picker',
			get_template_directory_uri() . '/inc/novelpro-unlimited/inc/color-picker/alpha-color-picker.css',
