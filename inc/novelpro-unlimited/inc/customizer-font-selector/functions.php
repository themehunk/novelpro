 ...
 * @since 1.1.38
 */
function novelpro_get_standard_fonts(){
 ...
 * @since 1.1.38
 */
function novelpro_get_google_fonts_array(){
 ...
 * @since 1.1.38
 */
function novelpro_enqueue_google_font($font){
	...
	$subsets        = '';
	$get_subsets    = get_theme_mod( 'novelpro_font_subsets', array( 'latin' ) );
	...
	// Enqueue style
	wp_enqueue_style( 'novelpro-google-font-' . $handle, $url, array(), false );
}