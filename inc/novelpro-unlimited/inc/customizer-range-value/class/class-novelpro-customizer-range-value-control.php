 ...
 * @access public
 */
class Novelpro_WP_Customizer_Range_Value_Control extends WP_Customize_Control {
	...
	public function enqueue(){
		wp_enqueue_script( 'customizer-range-value-control', get_template_directory_uri() . '/inc/novelpro-unlimited/inc/customizer-range-value/js/customizer-range-value-control.js', array( 'jquery', 'customize-base' ), '1.0.0', true );
		wp_enqueue_style( 'customizer-range-value-control', get_template_directory_uri() . '/inc/novelpro-unlimited/inc/customizer-range-value/css/customizer-range-value-control.css', array(), '1.0.0' );
	}
	/**
	 * Handles input value.
	 *
 ...
 * @since 1.1.38
 */
function novelpro_sanitize_range_value( $input ) {
	if ( novelpro_is_json( $input ) ) {
